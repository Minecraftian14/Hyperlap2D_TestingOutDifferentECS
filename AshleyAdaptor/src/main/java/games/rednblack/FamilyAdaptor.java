...
/**
 * Represents a group of {@link Component}s. It is used to describe what {@link Entity} objects an {@link com.badlogic.ashley.core.EntitySystem} should
 ...
 */
public class FamilyAdaptor {
    private static ObjectMap<String, FamilyAdaptor> families = new ObjectMap<String, FamilyAdaptor>();
    private static int familyIndex = 0;
    private static final BuilderAdaptor builder = new BuilderAdaptor();
     ...
     */
    private FamilyAdaptor(Bits all, Bits any, Bits exclude) {
        this.all = all;
        this.one = any;
     ...
     */
    @SafeVarargs
    public static final BuilderAdaptor all(Class<? extends Component>... componentTypes) {
     ...
     */
    @SafeVarargs
    public static final BuilderAdaptor one(Class<? extends Component>... componentTypes) {
     ...
     */
    @SafeVarargs
    public static final BuilderAdaptor exclude(Class<? extends Component>... componentTypes) {
        return builder.reset().exclude(componentTypes);
    }

    public static class BuilderAdaptor {
         ...
         */
        @SafeVarargs
        public final BuilderAdaptor all(Class<? extends Component>... componentTypes) {
         ...
         */
        @SafeVarargs
        public final BuilderAdaptor one(Class<? extends Component>... componentTypes) {
         ...
         */
        @SafeVarargs
        public final BuilderAdaptor exclude(Class<? extends Component>... componentTypes) {
         ...
         */
        public FamilyAdaptor get() {
            String hash = getFamilyHash(all, one, exclude);
            FamilyAdaptor family = families.get(hash, null);
            if (family == null) {
                family = new FamilyAdaptor(all, one, exclude);
